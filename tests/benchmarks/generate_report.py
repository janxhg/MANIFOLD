...
try:
    ...
    from tests.professional import benchmark_performance_enhanced, vis_trajectories
except ImportError:
    ...
    import tests.professional.benchmark_performance_enhanced as benchmark_performance_enhanced
    import tests.professional.vis_trajectories as vis_trajectories
    ...
    <div class="container">
        ...
        <div class="footer">
            ...
            <p style="margin-top: 10px; font-size: 0.9em;">
                ...
                <a href="https://github.com/your-repo/GFN" style="color: var(--primary);">GitHub</a>
            </p>
        </div>
    </div>
</body>
...
def generate_image_card(path, caption):
    ...
    if os.path.exists(path):
        rel_path = os.path.relpath(path, Path(path).parent.parent.parent / "tests" / "professional")
        return f"""
...
def run_full_suite(checkpoint_path=None):
    ...
    try:
        ...
        benchmark_df = benchmark_performance_enhanced.run_enhanced_suite()
...
def generate_html_report(results, output_path):
    ...
    benchmark_images = ""
    for img_name, caption in [
        ("memory_scaling_enhanced.png", "Memory scaling: O(1) vs O(N²) with curve fits"),
        ("memory_breakdown.png", "Forward vs backward pass memory breakdown"),
    ]:
        path = results_dir / img_name
    ...
    manifold_images = ""
    for img_name, caption in [
        ("geodesic_path_3d.png", "Geodesic vs Euclidean path in 3D"),
        ("trajectory_comparison.png", "GFN flow vs Transformer attention"),
        ("curvature_field.png", "Learned manifold curvature field"),
    ]:
        path = results_dir / img_name
...
def main():
    ...
    # Generate report
    output_path = args.output or (PROJECT_ROOT / "tests" / "professional" / "results" / "report.html")
